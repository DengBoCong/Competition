...
maxlen = 32
batch_size = 64
config_path = '../tcdata/chinese_L-12_H-768_A-12/bert_config.json'
checkpoint_path = '../tcdata/chinese_L-12_H-768_A-12/bert_model.ckpt'
dict_path = '../tcdata/chinese_L-12_H-768_A-12/vocab.txt'
...
# BERT词频
counts = json.load(open('../tcdata/counts.json'))
del counts['[CLS]']
del counts['[SEP]']
