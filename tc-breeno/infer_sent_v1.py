...
from code.infer_sent_model_v1 import model
...
from code.infer_sent_modules_v1 import evaluate
from code.infer_sent_modules_v1 import inference
from code.infer_sent_modules_v1 import train
...
def main() -> NoReturn:
    ...
    parser.add_argument("--num_layers", default=6, type=int, required=False, help="block层数")
    ...
    parser.add_argument("--raw_test_data_path", default="./tcdata/gaiic_track3_round1_testB_20210317.tsv", type=str,
